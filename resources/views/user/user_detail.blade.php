    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title">User Detail</h3>
                </div>
                <div>
                                ...
                                <form class="m-form m-form--fit m-form--label-align-right">
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-7">
                                                <input class="form-control m-input" value="user@gmail.com" type="email">
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row">
                                            <label for="example-text-input" class="col-2 col-form-label">Address 1</label>
                                            <div class="col-7">
                                                <input class="form-control m-input" value="mdy" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row">
                                            <label for="example-text-input" class="col-2 col-form-label">Address 2</label>
                                            <div class="col-7">
                                                <input class="form-control m-input" value="ygn" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-7">
                                                <input class="form-control m-input" value="chan aye thar san" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-7">
                                                <input class="form-control m-input" value="09420111333" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row">
                                            <label for="example-text-input" class="col-2 col-form-label">NRC NO</label>
                                            <div class="col-7">
                                                <input class="form-control m-input" value="9/MaKaNa(N)-1453434" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row">
                                            <label for="example-text-input" class="col-2 col-form-label">Business Type</label>
                                            <div class="col-7">
                                                <input class="form-control m-input" value="construction" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row">
                                            <label for="example-text-input" class="col-2 col-form-label">Working Bank</label>
                                            <div class="col-7">
                                                <input class="form-control m-input" value="KBZ" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row">
                                            <label for="example-text-input" class="col-2 col-form-label">Bank Acc No</label>
                                            <div class="col-7">
                                                <input class="form-control m-input" value="34342323232320" type="text">
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane " id="m_user_profile_tab_4">
                                <div class="m-portlet__body">
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-7">
                                            <p class="col-form-label">{{$user->id}}</p>
                                        </div>
                                    </div>
                                    <div class="form-group m-form__group row">

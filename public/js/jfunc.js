...
(function ($) {
    ...
    $.fn.dataTable.Buttons.defaults.dom.container.className = 'btn-group m-btn-group m-btn-group--pill';
    ...
    $.fn.jDatatable.defaults = {
        ...
        language: {
            ...
            decimal: ".",
            thousands: ",",
            emptyTable: "No Data Available In Yangon Steel Server",
            info: "Showing _START_ to _END_ of _TOTAL_ entries",
            infoEmpty: "No Entries Found In Yangon Steel Server",
            ...
            zeroRecords: "<h3 class='m--font-danger m-5'>No Matching Records Found In Yangon Steel Server</h3>",
            loadingRecords: "<i class=\"fa fa-spinner fa-spin fa-3x fa-fw\"></i>Server Loading...",
            processing: '<i class="fa fa-spinner fa-spin fa-3x fa-fw"></i>Server Processing....',
        },
        buttons: [
            // {
            //     text: 'Select all',
            ...
            // },
            {
                ...
                className: "m-btn btn btn-success",
                action: function (e, dt, node, config) {
            ...
            {
                extend: 'print',
                className: 'm-btn btn  m-btn--air btn-primary',
                ShowAll: true,
                message: "Generated by Yangon Steel",
                exportOptions: {orthogonal: 'export', columns: ':visible'},
                key: {key: 'p', altKey: true}
            },
            {
                extend: 'excel',
                className: 'm-btn btn  m-btn--air btn-info',
                exportOptions: {orthogonal: 'export', columns: ':visible'}
            },

            {
                extend: 'pdfHtml5',
                className: 'm-btn btn m-btn--air btn-success',
                pageSize: 'A4',
                exportOptions: {orthogonal: 'export', columns: ':visible'},
//                        download: 'open'
            },
            {
                extend: 'copy',
                className: 'm-btn btn m-btn--air btn-focus',
